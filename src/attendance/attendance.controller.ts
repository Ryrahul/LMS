...
export class AttendanceController {
  ...
  @Post('/:subjectId')
  createAttendacne(@Body() dto: AttendanceDto,@Param('subjectId',ParseIntPipe)subjectId:number) {
  ...
  @UseGuards(JwtAuthGuard,TeacherGuard)
  @Put()
  updateAttendacne(@Param('subjectId',ParseIntPipe)subjectId:number,@Param('id',ParseIntPipe)id:number){
